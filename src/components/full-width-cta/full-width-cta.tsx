...
function FullWdithCta({ title, text, linkText, link }: any) {
    ...
    return (
        <div className="pinkpanther-full-width-cta">
            ...
            {link && linkText && <p><Link to={link} target="blank" rel="noreferrer" className='pinkpanther-cta-link'>{linkText} →</Link></p>}
        </div>
    );
